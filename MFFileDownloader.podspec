...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of MFFileDownloader.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/NealWills/MFFileDownloader'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'NealWills' => 'NealWills93@gmail.com' }
  s.source           = { :git => 'https://github.com/NealWills/MFFileDownloader.git', :tag => s.version.to_s }
